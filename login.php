...
<body>
    <header>
        <nav class="barra-nav">
            <a href="index.html">
                <img src="assets/multimedia/pictures/icon.png" alt="Bobby Bunny" class="logo-img" onerror="this.outerHTML='<span class=logo-fallback>🐰</span>'">
            </a>
            ...
            <ul class="nav-ul">
                ...
                <li>
                    <a href="login.html" style="background:rgba(255,255,255,0.12); border:1px solid rgba(255,255,255,0.22); padding:6px 14px; border-radius:6px;">
                        Iniciar sesión
                    </a>
                </li>
            </ul>
    ...
    <div class="login-wrapper">
        <div class="login-card">
            <div class="login-icono"><span class="conejo">🐰</span></div>
            <h1>Bienvenido</h1>
            <p class="subtitulo">Inicia sesión en tu cuenta de Bobby Bunny Shop</p>
            ...
            <div class="campo">
                ...
                <div class="input-wrap">
                    ...
                    <input type="email" id="correo" placeholder="tu@correo.com" autocomplete="email">
                </div>
            </div>
